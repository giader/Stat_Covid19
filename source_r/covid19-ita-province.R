...
##results <- fromJSON("dpc-covid19-ita-province.json", flatten=TRUE)
result_regioni <- fromJSON("dpc-covid19-ita-regioni.json", flatten=TRUE)
result_nazione <- fromJSON("dpc-covid19-ita-andamento-nazionale.json", flatten=TRUE)
# Print the result.
# head(result)
# head(results)
# str(result)
